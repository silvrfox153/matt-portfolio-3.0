            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="text-slate-400 mt-2 text-sm leading-normal">
                  ...
                  campaigns. Provide general web strategy, content development,
                  eCommerce integration, business operation integration, UI
                  design, and SEO. Develop branding, social media, and email
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="text-slate-400 mt-2 text-sm leading-normal">
                  Primary advisor to municipal candidates on local issues,
                  policies, and campaign strategy. Developed and maintained
                  campaign websites and online infrastructure. Designed digital
                  and print marketing materials. Managed social media, and email
                  marketing campaigns. Researched and analyzed data from past
                  elections to target high-frequency voters. Recruited, trained,
                  and managed volunteers. Tracked volunteer interactions with
                  residents and built a database of potential voters using
                  MiniVAN and Votebuilder. Planned and executed fundraisers,
                  rallies, and GOTV efforts. Oversaw budget, fundraising, and
                  spending.
                </p>
                <ul className="mt-2 flex flex-wrap">
                  <li className="mr-1.5 mt-2">
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="text-slate-400 mt-2 text-sm leading-normal">
                  Managed a (24/7/365) NOC operations team responsible for
                  executing Demand Response protocols during grid emergencies.
                  Led operational execution of demand response programs in the
                  ISO-NE, PJM, CAISO, ERCOT, and Alberta electricity markets,
                  totaling over 3,500 MW provided by over 5,000 C&I customers.
                  Collaborated with Product Management, Engineering, and Program
                  Operations to develop procedures and tools to support Demand
                  Response and Ancillary Reserve Market programs. Created a
                  training and simulation framework designed to rehearse and
                  assess the team’s critical response skills and to identify
                  gaps in procedures/tools.
                </p>
                <ul className="mt-2 flex flex-wrap">
                  <li className="mr-1.5 mt-2">
                    <div className="flex items-center rounded-full bg-sky-400/10 px-3 py-1 text-xs font-medium leading-5 text-sky-300 ">
            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                <h3 className="font-medium leading-snug text-slate-200">
                  <div className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-sky-300 focus-visible:text-sky-300 undefined group text-base">
                    ...
                    <span>
                      ...
                      <span className="inline-block">
                        Golf Plus USA | Goodwin Golf Group
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 20 20"
                          fill="currentColor"
                ...
                <p className="text-slate-400 mt-2 text-sm leading-normal">
                  ...
                  offering POS, Tee Sheet Booking, and cart-mounted GPS systems.
                  Managed a team of Customer Service and Field Operation
                  Managers responsible for customer onboarding, maintenance, and
                  support. Worked closely with the business development team to
                  identify upsell opportunities and renewal risks. Responsible
                  for onsite GPS mapping and data collection. Analyzed and
                  corrected data integrity and mapping issues.
                </p>
                <ul className="mt-2 flex flex-wrap">
                  <li className="mr-1.5 mt-2">
                    <div className="flex items-center rounded-full bg-sky-400/10 px-3 py-1 text-xs font-medium leading-5 text-sky-300 ">
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="text-slate-400 mt-2 text-sm leading-normal">
                  Central point of contact for IT projects related to Mergers
                  and Acquisitions. Worked with network engineers, vendors, and
                  internal customers to determine network requirements within
                  acquisition projects. Managed timelines and communicated
