            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="text-slate-400 mt-2 text-sm leading-normal">
                  Designed and developed websites for small businesses using
                  WordPress, WooCommerce, and other web technologies.
                  Implemented web strategy, content development, eCommerce
                  integration, business operation integration, UI design, and
                  SEO best practices. Managed branding, social media, and email
                  marketing campaigns to drive traffic and conversions.
                  Monitored and maintained website performance, security, and
                  content. Reported on key metrics and analytics
                </p>
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="text-slate-400 mt-2 text-sm leading-normal">
                  Advised municipal candidates on local issues, policies, and
                  campaign strategy. Created and updated campaign websites and
                  online infrastructure. Produced digital and print marketing
                  materials. Executed social media and email marketing
                  campaigns. Analyzed data from past elections to target and
                  engage high-frequency voters. Recruited, trained, and managed
                  volunteers. Built a database of potential voters using
                  Votebuilder. Organized and ran fundraisers, rallies, and GOTV
                  efforts. Managed budget, fundraising, and spending.
                </p>
                <ul className="mt-2 flex flex-wrap">
                  <li className="mr-1.5 mt-2">
                    <div className="flex items-center rounded-full bg-sky-400/10 px-3 py-1 text-xs font-medium leading-5 text-sky-300 ">
            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="text-slate-400 mt-2 text-sm leading-normal">
                  ...
                  Ensured operational execution of demand response programs in
                  various electricity markets, totaling over 3,500 MW provided
                  by over 5,000 C&I customers. Worked with Product Management,
                  Engineering, and Program Operations to develop procedures and
                  tools to support Demand Response and Ancillary Reserve Market
                  programs. Established a training and simulation framework to
                  rehearse and assess the team’s critical response skills and to
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="text-slate-400 mt-2 text-sm leading-normal">
                  Led the operations of a Golf Management Solutions business
                  with POS, Tee Sheet Booking, and GPS systems. Supervised a
                  team of Customer Service and Field Operation Managers for
                  customer onboarding, maintenance, and support. Collaborated
                  with the business development team to identify upsell
                  opportunities and renewal risks. Installed GPS onsite and
                  collected data. Fixed data integrity and mapping errors.
                </p>
                <ul className="mt-2 flex flex-wrap">
                  <li className="mr-1.5 mt-2">
                    <div className="flex items-center rounded-full bg-sky-400/10 px-3 py-1 text-xs font-medium leading-5 text-sky-300 ">
